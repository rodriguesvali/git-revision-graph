...
- `tsconfig.webview.search.json` strictly checks the pure search query module. Query normalization, visible-reference filtering and result ordering no longer depend on the legacy interaction implementation.
