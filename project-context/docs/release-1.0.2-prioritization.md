...
- Initial `1.0.2` implementation scope covers focused Show Log compare restoration and dirty-worktree branch creation alignment with VS Code Source Control.
