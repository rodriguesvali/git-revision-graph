...
This document is preserved as background analysis for future graph-fidelity work. It is not active approved scope by itself. Use `project-context/docs/product-evolution-roadmap.md` and a focused feature artifact under `project-context/2.build/features/` for current planning.
