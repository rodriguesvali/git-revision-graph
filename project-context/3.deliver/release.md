...
- Release cycle status: `1.6.3` was opened on 2026-08-01 as a patch release. Current scope is package
  ...
  also exposes guarded local-branch checkout from exact commits, local tag creation, and compact
  expanded file lists. Packaging and publication remain subject to maintainer approval.
