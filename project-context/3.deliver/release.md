...
| Current automated source verification | Complete | Latest verification on 2026-07-16 passed `npm run quality:check` (217 production files and 2,077 functions), `npm run build`, `npm test` (731 tests), `npm run test:platform` (31 tests), and `git diff --check`. |
