...
test('renders a table-like show log webview shell with graph column and inline commit details support', () => {
  ...
  assert.doesNotMatch(html, /data-menu-action="compareCommits">Compare<\/button>'\s*\+\s*'<button class="context-menu-button" type="button" data-menu-action="cherryPickCommits">Cherry Pick<\/button>'\s*\+\s*'<button class="context-menu-button" type="button" data-menu-action="copyCommitHash">Copy Hash<\/button>'/s);
  assert.match(html, /data-menu-action="cherryPickCommits">Cherry Pick<\/button>'\s*\+\s*'<button class="context-menu-button" type="button" data-menu-action="resetToCommit">Reset to this<\/button>'\s*\+\s*'<button class="context-menu-button" type="button" data-menu-action="copyCommitHash">Copy Hash<\/button>'\s*\+\s*copyReferenceNameMenu/s);
