...
const exportedNames = [
  ...
  'createEmptyRevisionGraphWebviewVirtualIndex',
  'createEmptyRevisionGraphWebviewTopologyCaches',
  ...
  'createRevisionGraphWebviewTopologyCaches',
  ...
  'isRevisionGraphWebviewFlowAiBranchKind',
