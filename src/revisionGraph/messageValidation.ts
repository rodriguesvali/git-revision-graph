...
function validateProjectionRefScope(
  value: RawRevisionGraphMessage,
  options: MutableProjectionOptions
): boolean {
...
function validateProjectionBooleanOptions(
  value: RawRevisionGraphMessage,
  options: MutableProjectionOptions
): boolean {
...
function validateProjectionRevisionRange(
  value: RawRevisionGraphMessage,
  options: MutableProjectionOptions
): boolean {
...
function validateProjectionDescendantFocus(
  value: RawRevisionGraphMessage,
  options: MutableProjectionOptions
): boolean {
